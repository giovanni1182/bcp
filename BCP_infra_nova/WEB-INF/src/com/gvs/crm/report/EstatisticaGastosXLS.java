...
public class EstatisticaGastosXLS extends Excel
{
	public EstatisticaGastosXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Gastos");
      celula.setCellStyle(estiloTitulo);
      ...
      Map<String,Double> liquidadorMap = new TreeMap<String,Double>();
      Map<String,Double> aseguradoMap = new TreeMap<String,Double>();
      Map<String,Double> terceiroMap = new TreeMap<String,Double>();
      Map<String,Double> outrosMap = new TreeMap<String,Double>();
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  String linhaSuja = home.obterDadosAquivoGastos(aseg, c.getTime());
        	  ...
        	  double valor = Double.parseDouble(linhaStr[1]);
        	  liquidadorMap.put(mesAno, valor);
				
        	  valor = Double.parseDouble(linhaStr[2]);
        	  aseguradoMap.put(mesAno, valor);
			
        	  valor = Double.parseDouble(linhaStr[3]);
        	  terceiroMap.put(mesAno, valor);
				
        	  valor = Double.parseDouble(linhaStr[4]);
        	  outrosMap.put(mesAno, valor);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Importe pago al Liquidador en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double montante = 0;
				if(liquidadorMap.containsKey(mesAno))
					montante = liquidadorMap.get(mesAno);
        	  
              celula = row.createCell(coluna);
              celula.setCellValue(formataValor.format(montante));
              celula.setCellStyle(estiloTexto);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Importe pago al Asegurado en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double montante = 0;
				if(aseguradoMap.containsKey(mesAno))
					montante = aseguradoMap.get(mesAno);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Importe pago al Tercero en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double montante = 0;
				if(terceiroMap.containsKey(mesAno))
					montante = terceiroMap.get(mesAno);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Importe pago a Otros en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double montante = 0;
				if(outrosMap.containsKey(mesAno))
					montante = outrosMap.get(mesAno);
