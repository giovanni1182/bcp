...
public class MaioresSinistrosXLS extends Excel
{
	public MaioresSinistrosXLS(Collection<Sinistro> colecao, Date dataInicio, Date dataFim, String situacao, String tipoPessoa, String secao, int qtde, String textoUsuario, String modalidade) throws Exception 
	{
		...
		HSSFSheet planilha = wb.createSheet("Planilha");
	      ...
	      celula.setCellValue("Mayores Ocurrencias Siniestros " + new SimpleDateFormat("dd/MM/yyyy").format(dataInicio) + " hasta " + new SimpleDateFormat("dd/MM/yyyy").format(dataFim));
	      ...
	      celula.setCellValue("Montante Gs");
	      celula.setCellStyle(estiloTituloTabela);
	      ...
	      for(Sinistro sinistro : colecao)
	      {
		      ...
		      celula = row.createCell(5);
		      celula.setCellValue(apolice.obterPlano().obterSecao());
		      celula.setCellStyle(estiloTextoE);
