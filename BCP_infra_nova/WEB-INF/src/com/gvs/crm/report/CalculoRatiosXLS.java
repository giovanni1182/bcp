...
public class CalculoRatiosXLS extends Excel
{
	private Map<String,ClassificacaoContas> cContas;
	private Map<String,Conta> contas;
	private  EntidadeHome home;
	
	public CalculoRatiosXLS(Date dataInicio, Date dataFim, Collection<Entidade> aseguradoras, EntidadeHome home) throws Exception
	{
		...
		for(Iterator<Entidade> i = aseguradoras.iterator() ; i.hasNext() ; )
		{
			...
			while(c.getTime().compareTo(dataFimReal)<=0)
			{
				...
				row = planilha.createRow(linha);
				celula = row.createCell(coluna);
				celula.setCellValue(aseguradora.obterSigla());
				...
				double cContas1ValorAtual = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				double cContas1ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				double cContas1ValorDoisAnosAnterior = conta.obterTotalizacaoExistente(aseguradora,mesDoisAnosAnterior);

				conta = cContas.get("0401000000");
				double cContas2ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas2ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);

				conta = cContas.get("0402000000");
				double cContas3ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas3ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0403000000");
				double cContas4ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas4ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas5ValorAtual = conta.obterTotalizacaoExistente(aseguradora,	mesAnoCalculo);
				
				double cContas5ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,	mesAnoAnterior);
				double cContas5ValorDoisAnosAnterior = conta.obterTotalizacaoExistente(aseguradora,mesDoisAnosAnterior);
				
				conta = cContas.get("0501000000");
				double cContas6ValorAtual = conta.obterTotalizacaoExistente(aseguradora,	mesAnoCalculo);
				double cContas6ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);

				conta = cContas.get("0502000000");
				double cContas7ValorAtual = conta.obterTotalizacaoExistente(aseguradora,	mesAnoCalculo);
				double cContas7ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas8ValorAtual = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				double cContas8ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0507000000");
				double cContas9ValorAtual = conta.obterTotalizacaoExistente(aseguradora,	mesAnoCalculo);
				double cContas9ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,	mesAnoAnterior);
				
				conta = cContas.get("0508000000");
				double cContas10ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas10ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0509000000");
				double cContas11ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas11ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0512000000");
				double cContas12ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas12ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0407000000");
				double cContas13ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas13ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0412000000");
				double cContas14ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				...
				double cContas15ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas15ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0409000000");
				double cContas16ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas16ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas17ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas17ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0510000000");
				double cContas18ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas18ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0514000000");
				double cContas19ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0516000000");
				double cContas20ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0405000000");
				double cContas21ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0410000000");
				double cContas22ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas22ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0411000000");
				double cContas23ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas23ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0412000000");
				double cContas24ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas24ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0525000000");
				double cContas25ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				...
				double cContas26ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas26ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas27ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas27ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas28ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				...
				double cContas29ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				...
				double cContas30ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0601010000");
				double cContas31ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				...
				double cContas32ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				...
				double aux = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				conta = cContas.get("0500000000");
				aux-= conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				//double cContas33ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				...
				double cContas34ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas34ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0107000000");
				double cContas35ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas35ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0526000000");
				double cContas36ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas36ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas37ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0503000000");
				double cContas38ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0505000000");
				double cContas39ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas39ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0511000000");
				double cContas40ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas40ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0513000000");
				double cContas41ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas41ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0515000000");
				double cContas42ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas42ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0406000000");
				double cContas43ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas43ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0414000000");
				double cContas44ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas44ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0413000000");
				double cContas45ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0415000000");
				double cContas46ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0426000000");
				double cContas47ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas47ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta2 = contas.get("0525010401");
				double conta48ValorAtual = conta2.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double conta48ValorAnterior = conta2.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0527000000");
				double cContas49ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas49ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas51ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0102010000");
				double cContas52ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0103010000");
				double cContas53ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0102020000");
				double cContas54ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0103020000");
				double cContas55ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0203000000");
				double cContas56ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0106010000");
				double cContas57ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0202030000");
				double cContas58ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0202040000");
				double cContas59ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0214010000");
				double cContas60ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0202010000");
				double cContas61ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0202020000");
				double cContas62ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0202050000");
				double cContas63ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0202060000");
				double cContas64ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0102032000");
				double cContas65ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0103032000");
				double cContas66ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0102032100");
				double cContas67ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0103032100");
				double cContas68ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0106020000");
				double cContas69ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0525010700");
				double cContas70ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0525010800");
				double cContas71ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0525010400");
				double cContas72ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0102050000");
				double cContas73ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0102060000");
				double cContas74ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0104000000");
				double cContas75ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0105000000");
				double cContas76ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0109010000");
				double cContas77ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0109020000");
				double cContas78ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0109070000");
				double cContas79ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0109080000");
				double cContas80ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0206000000");
				double cContas81ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0210000000");
				double cContas82ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0211000000");
				double cContas83ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0205000000");
				double cContas84ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0214030000");
				double cContas86ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0214040000");
				double cContas87ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0109040000");
				double cContas88ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0109050000");
				double cContas89ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0109060000");
				double cContas90ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0211010200");
				double cContas91ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				
				conta = cContas.get("0405020000");
				double cContas51ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0102010000");
				double cContas52ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0103010000");
				double cContas53ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0102020000");
				double cContas54ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0103020000");
				double cContas55ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0203000000");
				double cContas56ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0106010000");
				double cContas57ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0202030000");
				double cContas58ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0202040000");
				double cContas59ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0214010000");
				double cContas60ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0202010000");
				double cContas61ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0202020000");
				double cContas62ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0202050000");
				double cContas63ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0202060000");
				double cContas64ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0102032000");
				double cContas65ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0103032000");
				double cContas66ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0102032100");
				double cContas67ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0103032100");
				double cContas68ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0106020000");
				double cContas69ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0525010700");
				double cContas70ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0525010800");
				double cContas71ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0525010400");
				double cContas72ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0102050000");
				double cContas73ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0102060000");
				double cContas74ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0104000000");
				double cContas75ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0105000000");
				double cContas76ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0109010000");
				double cContas77ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0109020000");
				double cContas78ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0109070000");
				double cContas79ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0109080000");
				double cContas80ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0206000000");
				double cContas81ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0210000000");
				double cContas82ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0211000000");
				double cContas83ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0205000000");
				double cContas84ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0214030000");
				double cContas86ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0214040000");
				double cContas87ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0109040000");
				double cContas88ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0109050000");
				double cContas89ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0109060000");
				double cContas90ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				
				conta = cContas.get("0211010200");
				double cContas91ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				...
				double cContas92ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas92ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				double cContas92ValorAnterior2Anos = conta.obterTotalizacaoExistente(aseguradora, mesDoisAnosAnterior);
				
				conta = cContas.get("0303020100");
				double cContas93ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas93ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				double cContas93ValorAnterior2Anos = conta.obterTotalizacaoExistente(aseguradora, mesDoisAnosAnterior);
				
				conta = cContas.get("0107010000");
				double cContas94ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas94ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				double cContas94ValorAnterior2Anos = conta.obterTotalizacaoExistente(aseguradora, mesDoisAnosAnterior);
				
				conta = cContas.get("0303020200");
				double cContas95ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas95ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				double cContas95ValorAnterior2Anos = conta.obterTotalizacaoExistente(aseguradora, mesDoisAnosAnterior);
				
				conta = cContas.get("0107060000");
				double cContas96ValorAtual = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				double cContas96ValorAnterior = conta.obterTotalizacaoExistente(aseguradora,mesAnoAnterior);
				double cContas96ValorAnterior2Anos = conta.obterTotalizacaoExistente(aseguradora, mesDoisAnosAnterior);
				...
				conta = cContas.get("0401000000");
				double valorIngresso1 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0402000000");
				double valorIngresso2 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0403000000");
				double valorIngresso3 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0404000000");
				double valorIngresso4 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0501000000");
				double valorIngresso5 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0502000000");
				double valorIngresso6 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0503000000");
				double valorIngresso7 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				
				conta = cContas.get("0506000000");
				double valorSinistro1 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0507000000");
				double valorSinistro2 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0508000000");
				double valorSinistro3 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0509000000");
				double valorSinistro4 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0511000000");
				double valorSinistro5 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0513000000");
				double valorSinistro6 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0515000000");
				double valorSinistro7 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0505000000");
				double valorSinistro8 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				
				conta = cContas.get("0407000000");
				double valorRecuperoSinistro1 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0408000000");
				double valorRecuperoSinistro2 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0409000000");
				double valorRecuperoSinistro3 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0412000000");
				double valorRecuperoSinistro4 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0414000000");
				double valorRecuperoSinistro5 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0406000000");
				double valorRecuperoSinistro6 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				...
				conta = cContas.get("0405000000");
				double valorIngressoTecnico1 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0410000000");
				double valorIngressoTecnico2 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0411000000");
				double valorIngressoTecnico3 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0413000000");
				double valorIngressoTecnico4 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0415000000");
				double valorIngressoTecnico5 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0426000000");
				double valorIngressoTecnico6 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				
				conta = cContas.get("0504000000");
				double valorEgressoTecnico1 = conta.obterTotalizacaoExistente(aseguradora,mesAnoCalculo);
				conta = cContas.get("0510000000");
				double valorEgressoTecnico2 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0512000000");
				double valorEgressoTecnico3 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0514000000");
				double valorEgressoTecnico4 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0516000000");
				double valorEgressoTecnico5 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0525000000");
				double valorEgressoTecnico6 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta2 = contas.get("0525010401");
				double valorEgressoTecnico7 = conta2.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0527000000");
				double valorEgressoTecnico8 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				...
				conta = cContas.get("0425000000");
				double valorInversao1 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0526000000");
				double valorInversao2 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0435000000");
				double valorExtraordinario1 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
				conta = cContas.get("0535000000");
				double valorExtraordinario2 = conta.obterTotalizacaoExistente(aseguradora, mesAnoCalculo);
