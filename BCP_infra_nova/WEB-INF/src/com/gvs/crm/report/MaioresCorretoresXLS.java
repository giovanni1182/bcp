...
public class MaioresCorretoresXLS extends Excel
{
	public MaioresCorretoresXLS(String tipoValor,Date dataInicio,Date dataFim, String situacao, double dolar, double euro, double real, double pesoArg, double pesoUru, double yen, Collection<String> dados, int qtde, String textoUsuario) throws Exception
	{
       ...
       celula.setCellValue("Mayores Corredores de Reaseguros".toUpperCase());
       celula.setCellStyle(estiloTitulo);
       ...
       row = planilha.createRow(linha);
       celula = row.createCell(0);
   	   celula.setCellValue("Cantidad: " + qtde);
       celula.setCellStyle(estiloTituloE);
       r = new Region(linha, (short)0, linha, (short)9);
       planilha.addMergedRegion(r);
