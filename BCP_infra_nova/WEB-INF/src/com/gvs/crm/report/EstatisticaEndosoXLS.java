...
public class EstatisticaEndosoXLS extends Excel
{
	public EstatisticaEndosoXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Endoso o Suplemento");
      celula.setCellStyle(estiloTitulo);
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Ajuste de Prima en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
