...
public class RelAlertaTrempano2XLS extends Excel
{
	private  EntidadeHome home;
	private Map<String,ClassificacaoContas> cContas;
	private Map<String,Conta> contas;
	private boolean calculoAnual,anoFiscal;
	private BigDecimal VALOR_DOLAR; 
	
	
	public RelAlertaTrempano2XLS(Collection<Aseguradora> aseguradoras, Date dataInicio, Date dataFim, int anoInicio, int anoFim, EntidadeHome home, AseguradoraHome aseguradoraHome, boolean anoFiscal) throws Exception
	{
		String caminho = "C:/tmp/" + new Date().getTime() + ".xls";
		this.home = home;
		this.anoFiscal = anoFiscal;
		
		VALOR_DOLAR = new BigDecimal("2885000000"); //(500000 * 5770)
		...
		calc.add("Primas directas / capital");
		...
		calc = new ArrayList<String>();
		calc.add("Cambio anual de las primas directas");
		...
		calc.add("Prima Neta / Patrimonio Tecnico");
		calc.add("Patrimonio Tecnico / Reservas Tecnicas");
		calc.add("Siniestros Controvertidos / Siniestros Pagados");
		calc.add("Siniestros Ocurridos / Prima Ganada Bruta");
		...
		calc = new ArrayList<String>();
		calc.add("Activo Corriente / Pasivo Corrriente");
		calc.add("Activo circulante / Reservas");
		
		calculos.put("Liquidez", calc);
		...
		for(Aseguradora aseguradora : aseguradoras)
		{
			...
			for(String grupo : calculos.keySet())
			{
				...
				for(String nomeCalculo : calculos2)
				{
					...
					//System.out.println(nomeCalculo);
					...
					while(c.getTime().compareTo(dataInicioReal)>=0)
					{
						...
						if(nomeCalculo.equals("Primas directas / capital"))
						{
		    				...
		    				{
		    					total = valor1.divide(valor6, 4, RoundingMode.HALF_EVEN);
							...
							{
								total = valor1G.divide(valor6G, 4, RoundingMode.HALF_EVEN);
		    					total = total.multiply(porCem);
							}
							...
							{
								total = valor1T.divide(valor6T, 4, RoundingMode.HALF_EVEN);
		    					total = total.multiply(porCem);
							}
						...
						else if(nomeCalculo.equals("Cambio anual de las primas directas"))
						{
							conta = cContas.get("0401000000");
		    				BigDecimal valor1 = this.totalConta(conta, dataCalculo, aseguradora, null);
		    				BigDecimal valor1G = this.totalConta(conta, dataCalculo, null, grupoAseguradora);
						...
						else if(nomeCalculo.equals("Demandas en disputa / reclamación total pagada"))
						{
		    				...
		    				conta = cContas.get("0506000000");//Siniestros Resultado Resumido
		    				BigDecimal valor2 = this.totalConta(conta, dataCalculo, aseguradora, null);
		    				BigDecimal valor2G = this.totalConta(conta, dataCalculo, null, grupoAseguradora);
		    				BigDecimal valor2T = this.totalConta(conta, dataCalculo, null, todasAseguradora);
						...
						else if(nomeCalculo.equals("Excedentes de capital/capital mínimo"))
						{
							...
							total = valor1.divide(VALOR_DOLAR, 4, RoundingMode.HALF_EVEN);
							...
							total = valor1G.divide(VALOR_DOLAR, 4, RoundingMode.HALF_EVEN);
							...
							total = valor1T.divide(VALOR_DOLAR, 4, RoundingMode.HALF_EVEN);
						...
						{
							conta = cContas.get("0504000000");//GASTOS DE PRODUCCION Resultado Resumido
							BigDecimal valor1 = this.totalConta(conta, dataCalculo, aseguradora, null);
							BigDecimal valor1G = this.totalConta(conta, dataCalculo, null, grupoAseguradora);
							BigDecimal valor1T = this.totalConta(conta, dataCalculo, null, todasAseguradora);
						...
						else if(nomeCalculo.equals("Provisiones Técnicas / Primas Directas"))
						{
							conta = cContas.get("0212000000");
		    				BigDecimal valor1 = this.totalConta(conta, dataCalculo, aseguradora, null);
		    				BigDecimal valor1G = this.totalConta(conta, dataCalculo, null, grupoAseguradora);
						...
						else if(nomeCalculo.equals("Provisiones Técnicas de Seguros/ Siniestros"))
						{
							//2.12/(Resultados Resumidos SINIESTROS) *100
							conta = cContas.get("0212000000");
		    				BigDecimal valor1 = this.totalConta(conta, dataCalculo, aseguradora, null);
		    				BigDecimal valor1G = this.totalConta(conta, dataCalculo, null, grupoAseguradora);
		    				BigDecimal valor1T = this.totalConta(conta, dataCalculo, null, todasAseguradora);
						...
						else if(nomeCalculo.equals("Prima Neta / Patrimonio Tecnico"))
						{
							//Pendiente
						}
						else if(nomeCalculo.equals("Patrimonio Tecnico / Reservas Tecnicas"))
						{
							//Pendiente
						}
						else if(nomeCalculo.equals("Siniestros Controvertidos / Siniestros Pagados"))
						{
							conta = cContas.get("0506000000");
		    				BigDecimal valor1 = this.totalConta(conta, dataCalculo, aseguradora, null);
		    				BigDecimal valor1G = this.totalConta(conta, dataCalculo, null, grupoAseguradora);
						...
						else if(nomeCalculo.equals("Siniestros Ocurridos / Prima Ganada Bruta"))
						{
							conta = cContas.get("0506000000");
		    				BigDecimal valor1 = this.totalConta(conta, dataCalculo, aseguradora, null);
		    				BigDecimal valor1G = this.totalConta(conta, dataCalculo, null, grupoAseguradora);
		    				...
		    				BigDecimal numerador = valor1.add(valor2).subtract(valor3);
							BigDecimal divisor = valor4;
							...
							numerador = valor1G.add(valor2G).subtract(valor3G);
							divisor = valor4G;
							...
							numerador = valor1T.add(valor2T).subtract(valor3T);
							divisor = valor4T;
						...
						else if(nomeCalculo.equals("Activo Corriente / Pasivo Corrriente"))
						{
							//Pendente
						}
						else if(nomeCalculo.equals("Activo circulante / Reservas"))
						{
							//Pendente
						}
	...
	private void instanciarContas() throws Exception
	{
		...
		String[] contas = {"0401000000","0402000000","0403000000","0501000000","0502000000","0301000000","0303000000","0301020000","0301010000","0107060000","0109000000","0102000000","0103000000","0104000000","0100000000","0107010000","0107020000",
				...
				"0409000000","0414000000","0405000000","0410000000","0411000000","0413000000","0415000000","0426000000","0510000000","0512000000","0514000000","0516000000","0527000000","0525010000"
		};
