...
public class LiquidadoresXLS extends Excel
{
	public LiquidadoresXLS(Collection lista, Date data, String obs, String textoUsuario,boolean ci) throws Exception
	{
        ...
        celula.setCellValue("LIQUIDADORES DE SINIESTROS CON INSCRIPCION VIGENTE - "+mes.toUpperCase()+" - "+ano+"");
        celula.setCellStyle(estiloTitulo);
        ...
        celula.setCellStyle(estiloTituloTabela);
        r = new Region(10, (short)11, 10, (short)12);
        planilha.addMergedRegion(r);
        
        celula = row.createCell(13);
        celula.setCellValue("Ciudad");
        celula.setCellStyle(estiloTituloTabela);
        
        celula = row.createCell(14);
        celula.setCellValue("Inicio Vig. Póliza");
        celula.setCellStyle(estiloTituloTabela);
        
        celula = row.createCell(15);
        celula.setCellValue("Fin Vig. Póliza");
        celula.setCellStyle(estiloTituloTabela);
        ...
        for(Iterator i = lista.iterator() ; i.hasNext() ; )
        {
            ...
            celula = row.createCell(14);
            celula.setCellValue(dataEmissao);
            if(cor)
            	celula.setCellStyle(estiloTextoCor);
            else
            	celula.setCellStyle(estiloTexto);
            ...
            celula = row.createCell(15);
            celula.setCellValue(dataVencimento);
            if(cor)
            	celula.setCellStyle(estiloTextoCor);
            else
            	celula.setCellStyle(estiloTexto);
        ...
        row = planilha.createRow(linha);
        celula = row.createCell(0);
        celula.setCellValue("Los Liquidadores " + dataStr);
        celula.setCellStyle(estiloTexto);
        r = new Region(linha, (short)0, linha, (short)9);
        planilha.addMergedRegion(r);
