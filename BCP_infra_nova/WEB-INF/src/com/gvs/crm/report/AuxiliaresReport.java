			...
			for (Iterator j = auxiliar.obterEventosComoOrigem().iterator(); j
				...
				if (e instanceof Inscricao) {
					...
					if (inscricao.obterNumeroResolucao() != null)
						row11.addCell(new Text("Nº de la Resolución: "
					...
					if (inscricao.obterDataResolucao() != null)
						row12
								.addCell(new Text("Fecha de la Resolución: "
										+ new SimpleDateFormat("dd/MM/yyyy")
												.format(inscricao
														.obterDataResolucao())));
					else
						row12.addCell(new Text("Fecha de la Resolución:"));
					...
					if (inscricao.obterSituacao() != null)
						row14.addCell(new Text("Situación: "
