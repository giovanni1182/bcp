...
public class EstatisticaReservasXLS extends Excel
{
	public EstatisticaReservasXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double risco = Double.parseDouble(linhaStr[1]);
        	  riscos.put(mesAno, risco);
				
        	  double sinistro = Double.parseDouble(linhaStr[2]);
        	  sinistros.put(mesAno, sinistro);
				
        	  double reserva = Double.parseDouble(linhaStr[3]);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Riesgo en Curso");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Siniestros Pendientes");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Reservas Matemáticas");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
