...
public class EstatisticaSinistrosXLS extends Excel
{
	public EstatisticaSinistrosXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Siniestros");
      celula.setCellStyle(estiloTitulo);
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double valor = Double.parseDouble(linhaStr[3]);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Monto Estimado en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Recupero de Reaseguro");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Recupero de Tercero");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
