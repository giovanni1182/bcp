...
public class MaioresReaseguradorasPDF extends PDF
{
	public MaioresReaseguradorasPDF(String tipoValor,Date dataInicio,Date dataFim, String situacao, double dolar, double euro, double real, double pesoArg, double pesoUru, double yen, Collection<String> dados, boolean porPais, String textoUsuario) throws Exception
	{
		...
		try 
	    {
	        ...
	        table = new PdfPTable(new float[]{0.40f, 0.20f, 0.20f, 0.20f});
	        table.setWidthPercentage(100f);
	        table.setSpacingAfter(10);
	        
	        if(porPais)
	        	p = new Paragraph("País", fontTextoNegrito);
	        else
	        	p = new Paragraph("Reaseguradora", fontTextoNegrito);
	        cell = new PdfPCell(p);
	        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
