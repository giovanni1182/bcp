...
public class EstatisticaCobrancaXLS extends Excel
{
	public EstatisticaCobrancaXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Cobranza");
      celula.setCellStyle(estiloTitulo);
      ...
      Map<String,Double> valorMap = new TreeMap<String,Double>();
      Map<String,Double> iteresMap = new TreeMap<String,Double>();
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  String linhaSuja = home.obterDadosAquivoCobranca(aseg, c.getTime());
        	  ...
        	  valorMap.put(mesAno, montante);
				
        	  double valor = Double.parseDouble(linhaStr[2]);
        	  iteresMap.put(mesAno, valor);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Valor de la Cobranza en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double montante = 0;
				if(valorMap.containsKey(mesAno))
					montante = valorMap.get(mesAno);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Interés de la Cobranza");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double valor = 0;
				if(iteresMap.containsKey(mesAno))
					valor = iteresMap.get(mesAno);
