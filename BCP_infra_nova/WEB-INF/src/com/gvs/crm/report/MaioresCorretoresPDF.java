...
public class MaioresCorretoresPDF extends PDF
{
	public MaioresCorretoresPDF(String tipoValor,Date dataInicio,Date dataFim, String situacao, double dolar, double euro, double real, double pesoArg, double pesoUru, double yen, Collection<String> dados, int qtde, String textoUsuario) throws Exception
	{
		...
		try 
	    {
	        ...
	        Paragraph p = new Paragraph("SUPERINTENDENCIA DE SEGUROS\nMayores Corredores de Reaseguros".toUpperCase(),fontTituloNegrito);
	        cell = new PdfPCell(p);
	        cell.setBorder(0);
	        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
	        table.addCell(cell);
        	...
        	p = new Paragraph("Cantidad: " + qtde, fontTituloNegrito);
	        documento.add(p);
        	...
        	p = new Paragraph("Corredor", fontTextoNegrito);
	        cell = new PdfPCell(p);
	        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
