...
public class CorretorReasegurosAseguradoraXLS extends Excel
{
	public CorretorReasegurosAseguradoraXLS(Entidade corretora, Date dataInicio, Date dataFim, Map aseguradoras, EntidadeHome home, String textoUsuario) throws Exception
	{
		...
		HSSFFont fonteTitulo = wb.createFont();
	      ...
	      celula.setCellValue("Corredora de Reaseguros - Aseguradoras");
	      ...
	      celula.setCellValue("Corredora: " + corretora.obterNome());
	      ...
	      for (Iterator i = aseguradoras.values().iterator(); i.hasNext();) 
	      {
				...
				double capitalGs = aseguradora.obterCapitalGsCorretora(corretora, dataInicio, dataFim,tipoContrato);
				double primaGs = aseguradora.obterPrimaGsCorretora(corretora, dataInicio, dataFim,tipoContrato);
				double comissaoGs = aseguradora.obterComissaoGsCorretora(corretora, dataInicio, dataFim,tipoContrato);
