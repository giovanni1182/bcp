...
public class ProducaoAseguradoraXLS extends Excel 
{
	public ProducaoAseguradoraXLS(AuxiliarSeguro auxiliar, Date dataInicio, Date dataFim) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Produción Aseguradoras");
      celula.setCellStyle(estiloTitulo);
      ...
      Collection<Aseguradora> agentes = auxiliar.obterAseguradoras2(dataInicio, dataFim);
