...
public class EstatisticaApoliceXLS extends Excel
{
	public EstatisticaApoliceXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome
			, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Datos del Instrumento");
      celula.setCellStyle(estiloTitulo);
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  String qtdeNovo = linhaStr[1];
        	  String qtdeRenovado = linhaStr[2];
        	  String capitalStr = linhaStr[3];
        	  String primaStr = linhaStr[4];
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Capital en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
