...
public class EstatisticaDemandaJudicialXLS extends Excel
{
	public EstatisticaDemandaJudicialXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Demanda Judicial");
      celula.setCellStyle(estiloTitulo);
