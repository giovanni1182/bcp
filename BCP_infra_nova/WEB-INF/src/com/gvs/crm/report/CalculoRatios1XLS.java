...
public class CalculoRatios1XLS extends Excel
{
	private Map<String,ClassificacaoContas> cContas;
	private Map<String,Conta> contas;
	private  EntidadeHome home;
	
	public CalculoRatios1XLS(Date dataInicio, Date dataFim, Collection<Entidade> aseguradoras, EntidadeHome home) throws Exception
	{
