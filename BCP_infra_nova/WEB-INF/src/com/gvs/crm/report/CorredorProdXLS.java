...
public class CorredorProdXLS extends Excel
{
	public CorredorProdXLS(AuxiliarSeguro auxiliar,Collection<Aseguradora> aseguradoras, Date dataInicio, Date dataFim) throws Exception
	{
		...
		HSSFSheet planilha = wb.createSheet("Planilha");
	      ...
	      celula.setCellValue("Produción Corredor de Seguros " + auxiliar.obterNome());
	      ...
	      for (Iterator<Aseguradora> i = aseguradoras.iterator(); i.hasNext();) 
	      {
		      ...
		      for (Iterator<Apolice> j = aseguradora.obterApolicesCorretor(auxiliar,dataInicio, dataFim).iterator(); j.hasNext();) 
		      {
