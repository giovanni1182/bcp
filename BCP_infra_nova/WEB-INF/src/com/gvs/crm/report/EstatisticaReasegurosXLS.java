...
public class EstatisticaReasegurosXLS extends Excel
{
	public EstatisticaReasegurosXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Provisiones y Reservas");
      celula.setCellStyle(estiloTitulo);
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  //String linhaSuja = home.obterDadosAquivoCoaseguros(aseg, c.getTime());
        	  String linhaSuja = home.obterDadosAquivoReaseguros(aseg, c.getTime());
				
        	  String[] linhaStr = linhaSuja.split(";");
        	  String qtde = linhaStr[0];
        	  
        	  double capital2 = Double.parseDouble(linhaStr[1]);
        	  capital.put(mesAno, capital2);
				
        	  double prima2 = Double.parseDouble(linhaStr[2]);
        	  prima.put(mesAno, prima2);
				
        	  double comissao2 = Double.parseDouble(linhaStr[3]);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Capital Reasegurado en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Prima en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Comisión en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
