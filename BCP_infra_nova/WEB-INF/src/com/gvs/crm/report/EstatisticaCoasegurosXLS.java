...
public class EstatisticaCoasegurosXLS extends Excel
{
	public EstatisticaCoasegurosXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Coaseguros");
      celula.setCellStyle(estiloTitulo);
