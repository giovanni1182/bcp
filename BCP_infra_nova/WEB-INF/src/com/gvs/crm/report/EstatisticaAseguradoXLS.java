...
public class EstatisticaAseguradoXLS extends Excel
{
	public EstatisticaAseguradoXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Datos del Asegurado");
      celula.setCellStyle(estiloTitulo);
