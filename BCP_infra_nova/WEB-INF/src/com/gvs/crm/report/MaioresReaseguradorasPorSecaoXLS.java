...
public class MaioresReaseguradorasPorSecaoXLS extends Excel
{
	public MaioresReaseguradorasPorSecaoXLS(String tipoValor,Date dataInicio,Date dataFim, String situacao, double dolar, double euro, double real, double pesoArg, double pesoUru, double yen, Collection<String> dados, String secao, String modalidade, String textoUsuario) throws Exception
	{
       ...
       celula.setCellValue("Mayores Reaseguradoras por Sección".toUpperCase());
       celula.setCellStyle(estiloTitulo);
