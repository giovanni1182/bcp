...
public class AseguradoraProdutividadeXSL extends Excel
{
	HSSFCellStyle estiloTitulo,estiloTituloJ,estiloTexto,estiloTextoN,estiloTextoCor,estiloTextoE,estiloTextoD,estiloTextoCorE,estiloTituloTabela,estiloTituloTabelaE;
	DecimalFormat format = new DecimalFormat("#,##0.00");
	int linha;
	
	public AseguradoraProdutividadeXSL(Aseguradora aseguradora, Collection agentes, Date dataInicio, Date dataFim, String textoUsuario, Collection<Apolice> apolicesSemAgentes) throws Exception
	{
		...
		HSSFSheet planilha = wb.createSheet("Planilha");
	      ...
	      celula.setCellValue("Produción Agentes de la Aseguradora " + aseguradora.obterNome());
	      ...
	      for (Iterator i = agentes.iterator(); i.hasNext();) 
	      {
		      ...
		      Collection<Apolice> apolices = agente.obterApolicesComoAgentePorPeriodo(dataInicio, dataFim, aseguradora);
	      ...
	      {
		      celula.setCellValue("Agente: 000");
		      celula.setCellStyle(estiloTituloTabelaE);
		      r = new Region(linha, (short)0, linha, (short)14);
		      planilha.addMergedRegion(r);
		      
		      linha++;
		      this.montaTabela(planilha, apolicesSemAgentes);
	      }
