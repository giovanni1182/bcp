...
public class EstatisticaFinancimantoXLS extends Excel
{
	public EstatisticaFinancimantoXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Refinanciación");
      celula.setCellStyle(estiloTitulo);
