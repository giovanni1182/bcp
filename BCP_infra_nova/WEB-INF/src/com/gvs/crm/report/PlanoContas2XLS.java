...
public class PlanoContas2XLS extends Excel
{
	public PlanoContas2XLS(AseguradoraHome home, String mes,String ano) throws Exception
	{
       ...
       celula.setCellValue("PLAN DE CUENTAS Grupo Coasegurador");
       ...
       Collection aseguradoras = home.obterAseguradorasPorMaior80();
