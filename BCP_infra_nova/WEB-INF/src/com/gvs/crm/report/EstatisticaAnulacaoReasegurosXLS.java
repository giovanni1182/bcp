...
public class EstatisticaAnulacaoReasegurosXLS extends Excel
{
	public EstatisticaAnulacaoReasegurosXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Anulación de Reaseguro");
      celula.setCellStyle(estiloTitulo);
