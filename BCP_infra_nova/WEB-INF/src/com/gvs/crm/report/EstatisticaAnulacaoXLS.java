...
public class EstatisticaAnulacaoXLS extends Excel
{
	public EstatisticaAnulacaoXLS(Aseguradora aseguradora, Date dataFim, ApoliceHome home, EntidadeHome entidadeHome, String textoUsuario) throws Exception
	{
      ...
      celula = row.createCell(5);
   	  ...
   	  celula.setCellValue("Estadística Anulación de Instrumento");
      celula.setCellStyle(estiloTitulo);
      ...
      for(Iterator<Aseguradora> i = aseguradoras.iterator() ; i.hasNext() ; )
      {
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double montante = Double.parseDouble(linhaStr[1]);
        	  capitalMap.put(mesAno, montante);
				
        	  double valor = Double.parseDouble(linhaStr[2]);
        	  ...
        	  valor = Double.parseDouble(linhaStr[5]);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Capital Anulado en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Prima Anulada en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Comisión Anulada en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double valor = 0;
				if(comissaoAnuladaMap.containsKey(mesAno))
					valor = comissaoAnuladaMap.get(mesAno);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Comisión a Recuperar en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double valor = 0;
				if(comissaoRecuperarMap.containsKey(mesAno))
					valor = comissaoRecuperarMap.get(mesAno);
          ...
          row = planilha.createRow(linha);
          celula = row.createCell(0);
          celula.setCellValue("Saldo de Anulación en Gs");
          celula.setCellStyle(estiloTextoE);
          r = new Region(linha, (short)0, linha, (short)1);
          planilha.addMergedRegion(r);
          ...
          while(c.getTime().compareTo(dataFim)<=0)
          {
        	  ...
        	  double valor = 0;
				if(saldoAnulacaoMap.containsKey(mesAno))
					valor = saldoAnulacaoMap.get(mesAno);
