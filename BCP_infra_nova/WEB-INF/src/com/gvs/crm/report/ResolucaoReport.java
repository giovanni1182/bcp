...
public class ResolucaoReport extends StellaReport {
	public ResolucaoReport(Resolucao resolucao, Locale locale) throws Exception {
		super(resolucao.obterSuperior().obterTitulo(), resolucao);

		DocumentoProduto documento = (DocumentoProduto) resolucao
				.obterSuperior();
