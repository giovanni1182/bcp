...
public class RelInformacaoMercadoView extends PortalView 
{
	private Date dataInicio, dataFim;
	private int anoInicio, anoFim;
	private String anoFiscal;
	
	public RelInformacaoMercadoView(Date dataInicio, Date dataFim, int anoInicio, int anoFim, String anoFiscal) throws Exception
	{
	...
	public View getBody(User user, Locale locale, Properties properties) throws Exception
	{
		...
		Button consultarButton = new Button("Generar Excel", new Action("calculoInformacaoMercado"));
	...
	{
		return new Label("Información del Mercado");
	}
