...
public class RecusarView extends PortalView {
	private Evento evento;

	public RecusarView(Evento evento) throws Exception {
		this.evento = evento;
	}
	...
	public View getTitle() throws Exception {
		return new Label(evento.obterClasseDescricao() + " - Recusar");
	}
