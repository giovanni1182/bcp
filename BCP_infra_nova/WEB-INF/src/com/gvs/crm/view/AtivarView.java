...
public class AtivarView extends PortalView {
	private Evento evento;

	public AtivarView(Evento evento) throws Exception {
		this.evento = evento;
	}
	...
	public View getBody(User user, Locale locale, Properties properties)
		...
		table.addSubtitle("Reativar");
		table.addHeader("Reativar:");
		table.addData(new EventoComentarioInput("comentario", ""));

		Button enviarButton = new Button("Reativar", new Action("ativarPlano"));
	...
	public View getTitle() throws Exception {
		return new Label(evento.obterClasseDescricao() + " - Reativar");
	}
