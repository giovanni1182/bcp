...
public class AprovarPlanoPorForaView extends PortalView {
	private Evento evento;

	private Action action;

	public AprovarPlanoPorForaView(Evento evento, Action action)
			throws Exception {
		this.evento = evento;
		this.action = action;
	}
	...
	public View getBody(User user, Locale locale, Properties properties)
		...
		Button enviarButton = new Button("Aprovar", new Action("aprovarPlano"));
