...
public class ApolicesPorCorretoraAseguradoraView extends BasicView {
	...
	public ApolicesPorCorretoraAseguradoraView(Entidade corretora,
	...
	public View execute(User arg0, Locale arg1, Properties arg2)
		...
		Button voltarButton = new Button("Volver", new Action(
				"visualizarReasegurosCorredorAseguradora"));
		voltarButton.getAction().add("corretorId", this.corretora.obterId());
