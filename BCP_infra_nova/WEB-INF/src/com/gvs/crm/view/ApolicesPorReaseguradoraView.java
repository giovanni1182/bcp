...
public class ApolicesPorReaseguradoraView extends BasicView {
	...
	public ApolicesPorReaseguradoraView(Aseguradora aseguradora,Collection apolices, String tipoContrato, Date dataInicio,Date dataFim, Action action) throws Exception 
	{
	...
	public View execute(User arg0, Locale arg1, Properties arg2)throws Exception 
	{
		...
		String dataInicioStr = new SimpleDateFormat("dd/MM/yyyy").format(this.dataInicio);
		String dataFimStr = new SimpleDateFormat("dd/MM/yyyy").format(this.dataFim);

		table.addSubtitle(this.apolices.size() + " Instrumentos - "	+ this.tipoContrato + " - " + dataInicioStr + " hasta "
				+ dataFimStr + " - " + this.aseguradora.obterNome());
		...
		for (Iterator i = this.apolices.iterator(); i.hasNext();) 
		{
			...
			String dataInicioVigencia = new SimpleDateFormat("dd/MM/yyyy").format(apolice.obterDataPrevistaInicio());
			String dataFimVigencia = new SimpleDateFormat("dd/MM/yyyy").format(apolice.obterDataPrevistaConclusao());
		...
		Button voltarButton = new Button("Volver", this.action);
		/*
