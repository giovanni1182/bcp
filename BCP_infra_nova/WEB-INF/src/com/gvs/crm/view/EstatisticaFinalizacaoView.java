...
public class EstatisticaFinalizacaoView extends PortalView
{
	...
	public EstatisticaFinalizacaoView(Aseguradora aseguradora, Date dataFim, boolean listar) throws Exception
	{
	...
	public View getBody(User user, Locale locale, Properties properties) throws Exception
	{
		...
		Button consultarButton = new Button("Consultar en la Pantalha",new Action("estatisticaFinalizacao"));
		block.add(new Space(25));
		block.add(consultarButton);
		block.add(new Space(4));
		consultarButton = new Button("Generar Excel",new Action("estatisticaFinalizacao"));
	...
	{
		return new Label("Estadística Finalización de Vigencia del Instrumento");
	}
}