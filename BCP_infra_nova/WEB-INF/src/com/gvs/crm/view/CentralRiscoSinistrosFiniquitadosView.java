...
public class CentralRiscoSinistrosFiniquitadosView extends Table 
{
	public CentralRiscoSinistrosFiniquitadosView(User user, Collection<Aseguradora> aseguradoras, String nomeAsegurado, String documento) throws Exception
	{
		super(7);
		...
		this.setNextHAlign(HALIGN_CENTER);
		this.addHeader("Monto Pagado en GS");
		this.setNextHAlign(HALIGN_CENTER);
		this.addHeader("M/E");
		this.setNextHAlign(HALIGN_CENTER);
		this.addHeader("Monto Pagado en M/E");
		...
		{
			sinistros = aseguradoraHome.obterSinistrosFiniquitadosCentralRisco(aseg, nomeAsegurado, documento); 
