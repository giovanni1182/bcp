...
public class RejeitarView extends PortalView {
	private Evento evento;

	private Action action;

	public RejeitarView(Evento evento, Action action) throws Exception {
		this.evento = evento;
		this.action = action;
	}
	...
	public View getBody(User user, Locale locale, Properties properties)
		...
		table.addSubtitle("Rejeción");
		table.addHeader("Rejeción:");
		table.addData(new EventoComentarioInput("comentario", ""));

		Button enviarButton = new Button("Rejeitar", new Action(
