...
public class TipoApoliceSelect extends BasicView {
	private String nome;
	...
	public TipoApoliceSelect(String nome, Aseguradora aseguradora, String valor)
			throws Exception {
		this.nome = nome;
	...
	public View execute(User user, Locale locale, Properties properties)
		...
		for (Iterator i = home.obterTiposApolice(aseguradora).iterator(); i
				.hasNext();) {
