...
public class HoraInput extends Block {
	public HoraInput(String nomeHora, Date valorInicial, boolean habilitado) {
		super(Block.HORIZONTAL);
		if (habilitado) {
			String hora = "";
			if (valorInicial != null)
				hora = new SimpleDateFormat("HH:mm").format(valorInicial);
			String[] horas = { "00:00", "00:30", "01:00", "01:30", "02:00",
			...
			this.add(new Label(valorInicial, "HH:mm"));
		}
	}
}